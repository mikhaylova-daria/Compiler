...
#ifndef MINIJAVACOMPILER_CIRTREELINEARIZATOR_H
#define MINIJAVACOMPILER_CIRTREELINEARIZATOR_H
...
namespace IRTree {
    ...
    class CIRTreeLinearizatior : public IIRTreeVisitor {
    public:
    ...
    private:
        bool isLastSEQ;
        bool collectStmList;
        std::shared_ptr<SEQStatement> currSEQ;
        std::shared_ptr<SEQStatement> lastSEQ;
